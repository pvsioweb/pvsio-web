...
static void initialize_c10_heart_model(SFc10_heart_modelInstanceStruct
  *chartInstance);
static void initialize_params_c10_heart_model(SFc10_heart_modelInstanceStruct
  *chartInstance);
static void enable_c10_heart_model(SFc10_heart_modelInstanceStruct
  *chartInstance);
static void disable_c10_heart_model(SFc10_heart_modelInstanceStruct
  *chartInstance);
static void c10_update_debugger_state_c10_heart_model
  (SFc10_heart_modelInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_heart_model
  (SFc10_heart_modelInstanceStruct *chartInstance);
static void set_sim_state_c10_heart_model(SFc10_heart_modelInstanceStruct
  *chartInstance, const mxArray *c10_st);
static void c10_set_sim_state_side_effects_c10_heart_model
  (SFc10_heart_modelInstanceStruct *chartInstance);
static void finalize_c10_heart_model(SFc10_heart_modelInstanceStruct
  *chartInstance);
static void sf_c10_heart_model(SFc10_heart_modelInstanceStruct *chartInstance);
static void c10_chartstep_c10_heart_model(SFc10_heart_modelInstanceStruct
  *chartInstance);
static void initSimStructsc10_heart_model(SFc10_heart_modelInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int8_T c10_emlrt_marshallIn(SFc10_heart_modelInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_b_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static uint32_T c10_b_emlrt_marshallIn(SFc10_heart_modelInstanceStruct
  *chartInstance, const mxArray *c10_b_resetEventCounter, const char_T
  *c10_identifier);
static uint32_T c10_c_emlrt_marshallIn(SFc10_heart_modelInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_c_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_d_emlrt_marshallIn(SFc10_heart_modelInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
...
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static uint8_T c10_e_emlrt_marshallIn(SFc10_heart_modelInstanceStruct
  *chartInstance, const mxArray *c10_b_tp_stimulated, const char_T
  *c10_identifier);
static uint8_T c10_f_emlrt_marshallIn(SFc10_heart_modelInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
...
static const mxArray *c10_e_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_g_emlrt_marshallIn(SFc10_heart_modelInstanceStruct
  *chartInstance, const mxArray *c10_q, const char_T *c10_identifier);
static real_T c10_h_emlrt_marshallIn(SFc10_heart_modelInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static boolean_T c10_i_emlrt_marshallIn(SFc10_heart_modelInstanceStruct
  *chartInstance, const mxArray *c10_reset, const char_T *c10_identifier);
static boolean_T c10_j_emlrt_marshallIn(SFc10_heart_modelInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static const mxArray *c10_k_emlrt_marshallIn(SFc10_heart_modelInstanceStruct
  *chartInstance, const mxArray *c10_b_setSimStateSideEffectsInfo, const char_T *
  c10_identifier);
static const mxArray *c10_l_emlrt_marshallIn(SFc10_heart_modelInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void init_dsm_address_info(SFc10_heart_modelInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_heart_model = 0U;
  chartInstance->c10_is_c10_heart_model = 0U;
  ...
  (SFc10_heart_modelInstanceStruct *chartInstance)
{
  ...
  c10_g_hoistedGlobal = chartInstance->c10_is_active_c10_heart_model;
  ...
  c10_h_hoistedGlobal = chartInstance->c10_is_c10_heart_model;
  ...
  *chartInstance, const mxArray *c10_st)
{
  ...
  *c10_reset = c10_i_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c10_is_active_c10_heart_model = c10_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 6)),
     "is_active_c10_heart_model");
  chartInstance->c10_is_c10_heart_model = c10_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c10_u, 7)), "is_c10_heart_model");
  ...
  c10_update_debugger_state_c10_heart_model(chartInstance);
...
static void sf_c10_heart_model(SFc10_heart_modelInstanceStruct *chartInstance)
{
  ...
  c10_vreset = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c10_q = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c10_set_sim_state_side_effects_c10_heart_model(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  if (*c10_event1 != 0) {
    ...
    c10_chartstep_c10_heart_model(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c10_is_active_c10_heart_model == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 7U, chartInstance->c10_sfEvent);
    chartInstance->c10_is_active_c10_heart_model = 1U;
    ...
    chartInstance->c10_is_c10_heart_model = c10_IN_resting;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c10_sfEvent);
    chartInstance->c10_tp_resting = 1U;
    *c10_q = 1.0;
    _SFD_DATA_RANGE_CHECK_MIN_MAX(*c10_q, 0U, 1.0, 4.0);
  } else {
    switch (chartInstance->c10_is_c10_heart_model) {
     case c10_IN_plateau:
      CV_CHART_EVAL(7, 0, 1);
      ...
      if (c10_out) {
        ...
        chartInstance->c10_tp_plateau = 0U;
        chartInstance->c10_is_c10_heart_model = c10_IN_NO_ACTIVE_CHILD;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c10_sfEvent);
        *c10_vreset = *c10_v;
        _SFD_DATA_RANGE_CHECK(*c10_vreset, 1U);
        chartInstance->c10_resetEventCounter++;
     ...
     case c10_IN_resting:
      ...
      if (c10_b_out) {
        ...
        *c10_vreset = *c10_v;
        ...
        _SFD_DATA_RANGE_CHECK(chartInstance->c10_vn, 3U);
        chartInstance->c10_resetEventCounter++;
        chartInstance->c10_is_c10_heart_model = c10_IN_stimulated;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c10_sfEvent);
        chartInstance->c10_tp_stimulated = 1U;
        *c10_q = 2.0;
        _SFD_DATA_RANGE_CHECK_MIN_MAX(*c10_q, 0U, 1.0, 4.0);
        ...
        if (c10_d_out) {
          ...
          *c10_vreset = *c10_v;
          _SFD_DATA_RANGE_CHECK(*c10_vreset, 1U);
          chartInstance->c10_resetEventCounter++;
          chartInstance->c10_is_c10_heart_model = c10_IN_upstroke;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c10_sfEvent);
          chartInstance->c10_tp_upstroke = 1U;
          *c10_q = 3.0;
          _SFD_DATA_RANGE_CHECK_MIN_MAX(*c10_q, 0U, 1.0, 4.0);
     ...
     case c10_IN_upstroke:
      ...
      if (c10_h_out) {
        ...
        *c10_vreset = *c10_v;
        _SFD_DATA_RANGE_CHECK(*c10_vreset, 1U);
        chartInstance->c10_resetEventCounter++;
        chartInstance->c10_is_c10_heart_model = c10_IN_plateau;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c10_sfEvent);
        chartInstance->c10_tp_plateau = 1U;
        *c10_q = 4.0;
        _SFD_DATA_RANGE_CHECK_MIN_MAX(*c10_q, 0U, 1.0, 4.0);
...
const mxArray *sf_c10_heart_model_get_eml_resolved_functions_info(void)
{
  ...
  *c10_inData)
{
  ...
  const mxArray *c10_y = NULL;
  SFc10_heart_modelInstanceStruct *chartInstance;
  chartInstance = (SFc10_heart_modelInstanceStruct *)chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c10_heart_model_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c10_heart_model_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c10_heart_model(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[3],T\"q\",},{M[1],M[41],T\"vno\",},{M[1],M[21],T\"vreset\",},{M[3],M[39],T\"vn\",},{M[6],M[20],T\"reset\",},{M[7],M[20],T\"resetEventCounter\",},{M[8],M[0],T\"is_active_c10_heart_model\",},{M[9],M[0],T\"is_c10_heart_model\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_heart_model_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc10_heart_modelInstanceStruct *chartInstance;
    chartInstance = (SFc10_heart_modelInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c10_heart_model(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_heart_modelInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c10_heart_model((SFc10_heart_modelInstanceStruct*)
    chartInstanceVar);
  initialize_c10_heart_model((SFc10_heart_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c10_heart_model(void *chartInstanceVar)
{
  enable_c10_heart_model((SFc10_heart_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_heart_model(void *chartInstanceVar)
{
  disable_c10_heart_model((SFc10_heart_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c10_heart_model(void *chartInstanceVar)
{
  sf_c10_heart_model((SFc10_heart_modelInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c10_heart_model(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_heart_model
    ((SFc10_heart_modelInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_heart_model();/* state var info */
...
extern void sf_internal_set_sim_state_c10_heart_model(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c10_heart_model((SFc10_heart_modelInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c10_heart_model(SimStruct* S)
{
  return sf_internal_get_sim_state_c10_heart_model(S);
}

static void sf_opaque_set_sim_state_c10_heart_model(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c10_heart_model(S, st);
}

static void sf_opaque_terminate_c10_heart_model(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_heart_modelInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c10_heart_model((SFc10_heart_modelInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc10_heart_model((SFc10_heart_modelInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_heart_model(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c10_heart_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c10_heart_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_heart_model(SimStruct *S)
{
  SFc10_heart_modelInstanceStruct *chartInstance;
  chartInstance = (SFc10_heart_modelInstanceStruct *)malloc(sizeof
    (SFc10_heart_modelInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_heart_modelInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c10_heart_model;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c10_heart_model;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c10_heart_model;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_heart_model;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_heart_model;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c10_heart_model;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c10_heart_model;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_heart_model;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_heart_model;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_heart_model;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_heart_model;
...
void c10_heart_model_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_heart_model(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_heart_model(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_heart_model(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_heart_model_method_dispatcher.\n"
