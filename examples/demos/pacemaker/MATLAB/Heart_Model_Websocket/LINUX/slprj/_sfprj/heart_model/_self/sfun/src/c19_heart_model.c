...
static void initialize_c19_heart_model(SFc19_heart_modelInstanceStruct
  *chartInstance);
static void initialize_params_c19_heart_model(SFc19_heart_modelInstanceStruct
  *chartInstance);
static void enable_c19_heart_model(SFc19_heart_modelInstanceStruct
  *chartInstance);
static void disable_c19_heart_model(SFc19_heart_modelInstanceStruct
  *chartInstance);
static void c19_update_debugger_state_c19_heart_model
  (SFc19_heart_modelInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c19_heart_model
  (SFc19_heart_modelInstanceStruct *chartInstance);
static void set_sim_state_c19_heart_model(SFc19_heart_modelInstanceStruct
  *chartInstance, const mxArray *c19_st);
static void c19_set_sim_state_side_effects_c19_heart_model
  (SFc19_heart_modelInstanceStruct *chartInstance);
static void finalize_c19_heart_model(SFc19_heart_modelInstanceStruct
  *chartInstance);
static void sf_c19_heart_model(SFc19_heart_modelInstanceStruct *chartInstance);
static void initSimStructsc19_heart_model(SFc19_heart_modelInstanceStruct
  *chartInstance);
...
static const mxArray *c19_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static uint32_T c19_emlrt_marshallIn(SFc19_heart_modelInstanceStruct
  *chartInstance, const mxArray *c19_b_event1EventCounter, const char_T
  *c19_identifier);
static uint32_T c19_b_emlrt_marshallIn(SFc19_heart_modelInstanceStruct
...
static const mxArray *c19_b_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static int32_T c19_c_emlrt_marshallIn(SFc19_heart_modelInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
...
static const mxArray *c19_c_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static uint8_T c19_d_emlrt_marshallIn(SFc19_heart_modelInstanceStruct
  *chartInstance, const mxArray *c19_b_tp_state, const char_T *c19_identifier);
static uint8_T c19_e_emlrt_marshallIn(SFc19_heart_modelInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
...
static const mxArray *c19_d_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static boolean_T c19_f_emlrt_marshallIn(SFc19_heart_modelInstanceStruct
  *chartInstance, const mxArray *c19_event1, const char_T *c19_identifier);
static boolean_T c19_g_emlrt_marshallIn(SFc19_heart_modelInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static const mxArray *c19_h_emlrt_marshallIn(SFc19_heart_modelInstanceStruct
  *chartInstance, const mxArray *c19_b_setSimStateSideEffectsInfo, const char_T *
  c19_identifier);
static const mxArray *c19_i_emlrt_marshallIn(SFc19_heart_modelInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void init_dsm_address_info(SFc19_heart_modelInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c19_is_active_c19_heart_model = 0U;
  chartInstance->c19_is_c19_heart_model = 0U;
  ...
  (SFc19_heart_modelInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c19_is_active_c19_heart_model == 1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 16U, chartInstance->c19_sfEvent);
  }

  if (chartInstance->c19_is_c19_heart_model == c19_IN_state) {
  ...
  (SFc19_heart_modelInstanceStruct *chartInstance)
{
  ...
  c19_g_hoistedGlobal = chartInstance->c19_is_active_c19_heart_model;
  ...
  c19_h_hoistedGlobal = chartInstance->c19_is_c19_heart_model;
...
static void sf_c19_heart_model(SFc19_heart_modelInstanceStruct *chartInstance)
{
  ...
  c19_set_sim_state_side_effects_c19_heart_model(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  if (chartInstance->c19_is_active_c19_heart_model == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 16U, chartInstance->c19_sfEvent);
    chartInstance->c19_is_active_c19_heart_model = 1U;
    ...
    chartInstance->c19_is_c19_heart_model = c19_IN_state;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c19_sfEvent);
    chartInstance->c19_tp_state = 1U;
  } else {
    ...
    if (c19_out) {
      ...
      chartInstance->c19_tp_state = 0U;
      chartInstance->c19_is_c19_heart_model = c19_IN_NO_ACTIVE_CHILD;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c19_sfEvent);
...
const mxArray *sf_c19_heart_model_get_eml_resolved_functions_info(void)
{
  ...
  *c19_inData)
{
  ...
  const mxArray *c19_y = NULL;
  SFc19_heart_modelInstanceStruct *chartInstance;
  chartInstance = (SFc19_heart_modelInstanceStruct *)chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c19_heart_model_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c19_heart_model_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c19_heart_model(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[6],M[65],T\"event1\",},{M[6],M[66],T\"event2\",},{M[6],M[67],T\"event3\",},{M[7],M[65],T\"event1EventCounter\",},{M[7],M[66],T\"event2EventCounter\",},{M[7],M[67],T\"event3EventCounter\",},{M[8],M[0],T\"is_active_c19_heart_model\",},{M[9],M[0],T\"is_c19_heart_model\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c19_heart_model_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc19_heart_modelInstanceStruct *chartInstance;
    chartInstance = (SFc19_heart_modelInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c19_heart_model(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc19_heart_modelInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c19_heart_model((SFc19_heart_modelInstanceStruct*)
    chartInstanceVar);
  initialize_c19_heart_model((SFc19_heart_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c19_heart_model(void *chartInstanceVar)
{
  enable_c19_heart_model((SFc19_heart_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c19_heart_model(void *chartInstanceVar)
{
  disable_c19_heart_model((SFc19_heart_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c19_heart_model(void *chartInstanceVar)
{
  sf_c19_heart_model((SFc19_heart_modelInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c19_heart_model(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c19_heart_model
    ((SFc19_heart_modelInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c19_heart_model();/* state var info */
...
extern void sf_internal_set_sim_state_c19_heart_model(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c19_heart_model((SFc19_heart_modelInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c19_heart_model(SimStruct* S)
{
  return sf_internal_get_sim_state_c19_heart_model(S);
}

static void sf_opaque_set_sim_state_c19_heart_model(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c19_heart_model(S, st);
}

static void sf_opaque_terminate_c19_heart_model(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc19_heart_modelInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c19_heart_model((SFc19_heart_modelInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc19_heart_model((SFc19_heart_modelInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c19_heart_model(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c19_heart_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c19_heart_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c19_heart_model(SimStruct *S)
{
  SFc19_heart_modelInstanceStruct *chartInstance;
  chartInstance = (SFc19_heart_modelInstanceStruct *)malloc(sizeof
    (SFc19_heart_modelInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc19_heart_modelInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c19_heart_model;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c19_heart_model;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c19_heart_model;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c19_heart_model;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c19_heart_model;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c19_heart_model;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c19_heart_model;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c19_heart_model;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c19_heart_model;
  chartInstance->chartInfo.mdlStart = mdlStart_c19_heart_model;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c19_heart_model;
...
void c19_heart_model_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c19_heart_model(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c19_heart_model(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c19_heart_model(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c19_heart_model_method_dispatcher.\n"
