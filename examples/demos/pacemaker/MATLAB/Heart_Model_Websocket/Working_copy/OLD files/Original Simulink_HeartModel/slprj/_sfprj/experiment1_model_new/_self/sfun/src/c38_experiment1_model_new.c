...
#include "c38_experiment1_model_new.h"
...
static void initialize_c38_experiment1_model_new
  (SFc38_experiment1_model_newInstanceStruct *chartInstance);
static void initialize_params_c38_experiment1_model_new
  (SFc38_experiment1_model_newInstanceStruct *chartInstance);
static void enable_c38_experiment1_model_new
  (SFc38_experiment1_model_newInstanceStruct *chartInstance);
static void disable_c38_experiment1_model_new
  (SFc38_experiment1_model_newInstanceStruct *chartInstance);
static void c38_update_debugger_state_c38_experiment1_model_new
  (SFc38_experiment1_model_newInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c38_experiment1_model_new
  (SFc38_experiment1_model_newInstanceStruct *chartInstance);
static void set_sim_state_c38_experiment1_model_new
  (SFc38_experiment1_model_newInstanceStruct *chartInstance, const mxArray
   *c38_st);
static void c38_set_sim_state_side_effects_c38_experiment1_model_new
  (SFc38_experiment1_model_newInstanceStruct *chartInstance);
static void finalize_c38_experiment1_model_new
  (SFc38_experiment1_model_newInstanceStruct *chartInstance);
static void sf_c38_experiment1_model_new
  (SFc38_experiment1_model_newInstanceStruct *chartInstance);
static void c38_chartstep_c38_experiment1_model_new
  (SFc38_experiment1_model_newInstanceStruct *chartInstance);
static void initSimStructsc38_experiment1_model_new
  (SFc38_experiment1_model_newInstanceStruct *chartInstance);
...
static const mxArray *c38_sf_marshallOut(void *chartInstanceVoid, void
  *c38_inData);
static int8_T c38_emlrt_marshallIn(SFc38_experiment1_model_newInstanceStruct
...
static const mxArray *c38_b_sf_marshallOut(void *chartInstanceVoid, void
  *c38_inData);
static uint32_T c38_b_emlrt_marshallIn(SFc38_experiment1_model_newInstanceStruct
  *chartInstance, const mxArray *c38_b_resetEventCounter, const char_T
  *c38_identifier);
static uint32_T c38_c_emlrt_marshallIn(SFc38_experiment1_model_newInstanceStruct
  *chartInstance, const mxArray *c38_u, const emlrtMsgIdentifier *c38_parentId);
...
static const mxArray *c38_c_sf_marshallOut(void *chartInstanceVoid, void
  *c38_inData);
static int32_T c38_d_emlrt_marshallIn(SFc38_experiment1_model_newInstanceStruct *
  chartInstance, const mxArray *c38_u, const emlrtMsgIdentifier *c38_parentId);
...
static const mxArray *c38_d_sf_marshallOut(void *chartInstanceVoid, void
  *c38_inData);
static uint8_T c38_e_emlrt_marshallIn(SFc38_experiment1_model_newInstanceStruct *
  chartInstance, const mxArray *c38_b_tp_resting, const char_T *c38_identifier);
static uint8_T c38_f_emlrt_marshallIn(SFc38_experiment1_model_newInstanceStruct *
  chartInstance, const mxArray *c38_u, const emlrtMsgIdentifier *c38_parentId);
...
static const mxArray *c38_e_sf_marshallOut(void *chartInstanceVoid, void
  *c38_inData);
static real_T c38_g_emlrt_marshallIn(SFc38_experiment1_model_newInstanceStruct
  *chartInstance, const mxArray *c38_q, const char_T *c38_identifier);
static real_T c38_h_emlrt_marshallIn(SFc38_experiment1_model_newInstanceStruct
  *chartInstance, const mxArray *c38_u, const emlrtMsgIdentifier *c38_parentId);
static void c38_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c38_mxArrayInData, const char_T *c38_varName, void *c38_outData);
static boolean_T c38_i_emlrt_marshallIn
  (SFc38_experiment1_model_newInstanceStruct *chartInstance, const mxArray
   *c38_reset, const char_T *c38_identifier);
static boolean_T c38_j_emlrt_marshallIn
  (SFc38_experiment1_model_newInstanceStruct *chartInstance, const mxArray
   *c38_u, const emlrtMsgIdentifier *c38_parentId);
static const mxArray *c38_k_emlrt_marshallIn
  (SFc38_experiment1_model_newInstanceStruct *chartInstance, const mxArray
   *c38_b_setSimStateSideEffectsInfo, const char_T *c38_identifier);
static const mxArray *c38_l_emlrt_marshallIn
  (SFc38_experiment1_model_newInstanceStruct *chartInstance, const mxArray
   *c38_u, const emlrtMsgIdentifier *c38_parentId);
static void init_dsm_address_info(SFc38_experiment1_model_newInstanceStruct
  *chartInstance);
  ...
  (SFc38_experiment1_model_newInstanceStruct *chartInstance)
{
  ...
  chartInstance->c38_is_active_c38_experiment1_model_new = 0U;
  chartInstance->c38_is_c38_experiment1_model_new = 0U;
  ...
  (SFc38_experiment1_model_newInstanceStruct *chartInstance)
{
  ...
  c38_g_hoistedGlobal = chartInstance->c38_is_active_c38_experiment1_model_new;
  ...
  c38_h_hoistedGlobal = chartInstance->c38_is_c38_experiment1_model_new;
   ...
   *c38_st)
{
  ...
  *c38_reset = c38_i_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c38_is_active_c38_experiment1_model_new =
    c38_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c38_u, 6)),
    "is_active_c38_experiment1_model_new");
  chartInstance->c38_is_c38_experiment1_model_new = c38_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c38_u, 7)),
     "is_c38_experiment1_model_new");
  ...
  c38_update_debugger_state_c38_experiment1_model_new(chartInstance);
  ...
  (SFc38_experiment1_model_newInstanceStruct *chartInstance)
{
  ...
  c38_vreset = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c38_q = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c38_set_sim_state_side_effects_c38_experiment1_model_new(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  if (*c38_event1 != 0) {
    ...
    c38_chartstep_c38_experiment1_model_new(chartInstance);
  ...
  (SFc38_experiment1_model_newInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c38_is_active_c38_experiment1_model_new == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 35U, chartInstance->c38_sfEvent);
    chartInstance->c38_is_active_c38_experiment1_model_new = 1U;
    ...
    chartInstance->c38_is_c38_experiment1_model_new = c38_IN_resting;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c38_sfEvent);
    chartInstance->c38_tp_resting = 1U;
    *c38_q = 1.0;
    _SFD_DATA_RANGE_CHECK_MIN_MAX(*c38_q, 0U, 1.0, 4.0);
  } else {
    switch (chartInstance->c38_is_c38_experiment1_model_new) {
     case c38_IN_plateau:
      ...
      if (c38_out) {
        ...
        chartInstance->c38_tp_plateau = 0U;
        chartInstance->c38_is_c38_experiment1_model_new = c38_IN_NO_ACTIVE_CHILD;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c38_sfEvent);
        *c38_vreset = *c38_v;
        _SFD_DATA_RANGE_CHECK(*c38_vreset, 1U);
        chartInstance->c38_resetEventCounter++;
     ...
     case c38_IN_resting:
      ...
      if (c38_b_out) {
        ...
        *c38_vreset = *c38_v;
        ...
        _SFD_DATA_RANGE_CHECK(chartInstance->c38_vn, 3U);
        chartInstance->c38_resetEventCounter++;
        chartInstance->c38_is_c38_experiment1_model_new = c38_IN_stimulated;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c38_sfEvent);
        chartInstance->c38_tp_stimulated = 1U;
        *c38_q = 2.0;
        _SFD_DATA_RANGE_CHECK_MIN_MAX(*c38_q, 0U, 1.0, 4.0);
        ...
        if (c38_d_out) {
          ...
          chartInstance->c38_tp_resting = 0U;
          chartInstance->c38_is_c38_experiment1_model_new =
            c38_IN_NO_ACTIVE_CHILD;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c38_sfEvent);
          *c38_vreset = *c38_v;
          _SFD_DATA_RANGE_CHECK(*c38_vreset, 1U);
          chartInstance->c38_resetEventCounter++;
          chartInstance->c38_is_c38_experiment1_model_new = c38_IN_upstroke;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c38_sfEvent);
          chartInstance->c38_tp_upstroke = 1U;
          *c38_q = 3.0;
          _SFD_DATA_RANGE_CHECK_MIN_MAX(*c38_q, 0U, 1.0, 4.0);
     ...
     case c38_IN_upstroke:
      ...
      if (c38_h_out) {
        ...
        *c38_vreset = *c38_v;
        _SFD_DATA_RANGE_CHECK(*c38_vreset, 1U);
        chartInstance->c38_resetEventCounter++;
        chartInstance->c38_is_c38_experiment1_model_new = c38_IN_plateau;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c38_sfEvent);
        chartInstance->c38_tp_plateau = 1U;
        *c38_q = 4.0;
        _SFD_DATA_RANGE_CHECK_MIN_MAX(*c38_q, 0U, 1.0, 4.0);
...
const mxArray *sf_c38_experiment1_model_new_get_eml_resolved_functions_info(void)
{
  ...
  *c38_inData)
{
  ...
  const mxArray *c38_y = NULL;
  SFc38_experiment1_model_newInstanceStruct *chartInstance;
  chartInstance = (SFc38_experiment1_model_newInstanceStruct *)chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c38_experiment1_model_new_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c38_experiment1_model_new_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c38_experiment1_model_new(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[3],T\"q\",},{M[1],M[41],T\"vno\",},{M[1],M[21],T\"vreset\",},{M[3],M[39],T\"vn\",},{M[6],M[20],T\"reset\",},{M[7],M[20],T\"resetEventCounter\",},{M[8],M[0],T\"is_active_c38_experiment1_model_new\",},{M[9],M[0],T\"is_c38_experiment1_model_new\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c38_experiment1_model_new_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc38_experiment1_model_newInstanceStruct *chartInstance;
    chartInstance = (SFc38_experiment1_model_newInstanceStruct *)
...
static void sf_opaque_initialize_c38_experiment1_model_new(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc38_experiment1_model_newInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c38_experiment1_model_new
    ((SFc38_experiment1_model_newInstanceStruct*) chartInstanceVar);
  initialize_c38_experiment1_model_new
    ((SFc38_experiment1_model_newInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c38_experiment1_model_new(void *chartInstanceVar)
{
  enable_c38_experiment1_model_new((SFc38_experiment1_model_newInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c38_experiment1_model_new(void *chartInstanceVar)
{
  disable_c38_experiment1_model_new((SFc38_experiment1_model_newInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c38_experiment1_model_new(void *chartInstanceVar)
{
  sf_c38_experiment1_model_new((SFc38_experiment1_model_newInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c38_experiment1_model_new
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c38_experiment1_model_new
    ((SFc38_experiment1_model_newInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c38_experiment1_model_new();/* state var info */
...
extern void sf_internal_set_sim_state_c38_experiment1_model_new(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c38_experiment1_model_new
    ((SFc38_experiment1_model_newInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c38_experiment1_model_new
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c38_experiment1_model_new(S);
}

static void sf_opaque_set_sim_state_c38_experiment1_model_new(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c38_experiment1_model_new(S, st);
}

static void sf_opaque_terminate_c38_experiment1_model_new(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc38_experiment1_model_newInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c38_experiment1_model_new
      ((SFc38_experiment1_model_newInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc38_experiment1_model_new
    ((SFc38_experiment1_model_newInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c38_experiment1_model_new(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c38_experiment1_model_new
      ((SFc38_experiment1_model_newInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c38_experiment1_model_new(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c38_experiment1_model_new(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c38_experiment1_model_new(SimStruct *S)
{
  SFc38_experiment1_model_newInstanceStruct *chartInstance;
  chartInstance = (SFc38_experiment1_model_newInstanceStruct *)malloc(sizeof
    (SFc38_experiment1_model_newInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc38_experiment1_model_newInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c38_experiment1_model_new;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c38_experiment1_model_new;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c38_experiment1_model_new;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c38_experiment1_model_new;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c38_experiment1_model_new;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c38_experiment1_model_new;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c38_experiment1_model_new;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c38_experiment1_model_new;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c38_experiment1_model_new;
  chartInstance->chartInfo.mdlStart = mdlStart_c38_experiment1_model_new;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c38_experiment1_model_new;
...
void c38_experiment1_model_new_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c38_experiment1_model_new(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c38_experiment1_model_new(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c38_experiment1_model_new(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c38_experiment1_model_new_method_dispatcher.\n"
