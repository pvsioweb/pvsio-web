...
#include "c9_experiment1_model_new.h"
...
static void initialize_c9_experiment1_model_new
  (SFc9_experiment1_model_newInstanceStruct *chartInstance);
static void initialize_params_c9_experiment1_model_new
  (SFc9_experiment1_model_newInstanceStruct *chartInstance);
static void enable_c9_experiment1_model_new
  (SFc9_experiment1_model_newInstanceStruct *chartInstance);
static void disable_c9_experiment1_model_new
  (SFc9_experiment1_model_newInstanceStruct *chartInstance);
static void c9_update_debugger_state_c9_experiment1_model_new
  (SFc9_experiment1_model_newInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c9_experiment1_model_new
  (SFc9_experiment1_model_newInstanceStruct *chartInstance);
static void set_sim_state_c9_experiment1_model_new
  (SFc9_experiment1_model_newInstanceStruct *chartInstance, const mxArray *c9_st);
static void c9_set_sim_state_side_effects_c9_experiment1_model_new
  (SFc9_experiment1_model_newInstanceStruct *chartInstance);
static void finalize_c9_experiment1_model_new
  (SFc9_experiment1_model_newInstanceStruct *chartInstance);
static void sf_c9_experiment1_model_new(SFc9_experiment1_model_newInstanceStruct
  *chartInstance);
static void initSimStructsc9_experiment1_model_new
  (SFc9_experiment1_model_newInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static uint32_T c9_emlrt_marshallIn(SFc9_experiment1_model_newInstanceStruct
  *chartInstance, const mxArray *c9_b_event1EventCounter, const char_T
  *c9_identifier);
static uint32_T c9_b_emlrt_marshallIn(SFc9_experiment1_model_newInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_b_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_c_emlrt_marshallIn(SFc9_experiment1_model_newInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_c_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static uint8_T c9_d_emlrt_marshallIn(SFc9_experiment1_model_newInstanceStruct
  *chartInstance, const mxArray *c9_b_tp_state, const char_T *c9_identifier);
static uint8_T c9_e_emlrt_marshallIn(SFc9_experiment1_model_newInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_d_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static boolean_T c9_f_emlrt_marshallIn(SFc9_experiment1_model_newInstanceStruct *
  chartInstance, const mxArray *c9_event1, const char_T *c9_identifier);
static boolean_T c9_g_emlrt_marshallIn(SFc9_experiment1_model_newInstanceStruct *
  chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static const mxArray *c9_h_emlrt_marshallIn
  (SFc9_experiment1_model_newInstanceStruct *chartInstance, const mxArray
   *c9_b_setSimStateSideEffectsInfo, const char_T *c9_identifier);
static const mxArray *c9_i_emlrt_marshallIn
  (SFc9_experiment1_model_newInstanceStruct *chartInstance, const mxArray *c9_u,
   const emlrtMsgIdentifier *c9_parentId);
static void init_dsm_address_info(SFc9_experiment1_model_newInstanceStruct
  *chartInstance);
  ...
  (SFc9_experiment1_model_newInstanceStruct *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_experiment1_model_new = 0U;
  chartInstance->c9_is_c9_experiment1_model_new = 0U;
  ...
  (SFc9_experiment1_model_newInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c9_is_active_c9_experiment1_model_new == 1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 6U, chartInstance->c9_sfEvent);
  }

  if (chartInstance->c9_is_c9_experiment1_model_new == c9_IN_state) {
  ...
  (SFc9_experiment1_model_newInstanceStruct *chartInstance)
{
  ...
  c9_g_hoistedGlobal = chartInstance->c9_is_active_c9_experiment1_model_new;
  c9_g_u = c9_g_hoistedGlobal;
  c9_h_y = NULL;
  sf_mex_assign(&c9_h_y, sf_mex_create("y", &c9_g_u, 3, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c9_y, 6, c9_h_y);
  c9_h_hoistedGlobal = chartInstance->c9_is_c9_experiment1_model_new;
  ...
  (SFc9_experiment1_model_newInstanceStruct *chartInstance, const mxArray *c9_st)
{
  ...
  *c9_event3 = c9_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c9_is_active_c9_experiment1_model_new = c9_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 6)),
     "is_active_c9_experiment1_model_new");
  chartInstance->c9_is_c9_experiment1_model_new = c9_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 7)),
     "is_c9_experiment1_model_new");
  ...
  c9_update_debugger_state_c9_experiment1_model_new(chartInstance);
  ...
  *chartInstance)
{
  ...
  c9_set_sim_state_side_effects_c9_experiment1_model_new(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  if (chartInstance->c9_is_active_c9_experiment1_model_new == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 6U, chartInstance->c9_sfEvent);
    chartInstance->c9_is_active_c9_experiment1_model_new = 1U;
    ...
    chartInstance->c9_is_c9_experiment1_model_new = c9_IN_state;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c9_sfEvent);
    chartInstance->c9_tp_state = 1U;
  } else {
    ...
    if (c9_out) {
      ...
      chartInstance->c9_tp_state = 0U;
      chartInstance->c9_is_c9_experiment1_model_new = c9_IN_NO_ACTIVE_CHILD;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c9_sfEvent);
...
const mxArray *sf_c9_experiment1_model_new_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  const mxArray *c9_y = NULL;
  SFc9_experiment1_model_newInstanceStruct *chartInstance;
  chartInstance = (SFc9_experiment1_model_newInstanceStruct *)chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c9_experiment1_model_new_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c9_experiment1_model_new_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c9_experiment1_model_new(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[6],M[65],T\"event1\",},{M[6],M[66],T\"event2\",},{M[6],M[67],T\"event3\",},{M[7],M[65],T\"event1EventCounter\",},{M[7],M[66],T\"event2EventCounter\",},{M[7],M[67],T\"event3EventCounter\",},{M[8],M[0],T\"is_active_c9_experiment1_model_new\",},{M[9],M[0],T\"is_c9_experiment1_model_new\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_experiment1_model_new_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc9_experiment1_model_newInstanceStruct *chartInstance;
    chartInstance = (SFc9_experiment1_model_newInstanceStruct *)
...
static void sf_opaque_initialize_c9_experiment1_model_new(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_experiment1_model_newInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c9_experiment1_model_new
    ((SFc9_experiment1_model_newInstanceStruct*) chartInstanceVar);
  initialize_c9_experiment1_model_new((SFc9_experiment1_model_newInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c9_experiment1_model_new(void *chartInstanceVar)
{
  enable_c9_experiment1_model_new((SFc9_experiment1_model_newInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c9_experiment1_model_new(void *chartInstanceVar)
{
  disable_c9_experiment1_model_new((SFc9_experiment1_model_newInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c9_experiment1_model_new(void *chartInstanceVar)
{
  sf_c9_experiment1_model_new((SFc9_experiment1_model_newInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c9_experiment1_model_new
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c9_experiment1_model_new
    ((SFc9_experiment1_model_newInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c9_experiment1_model_new();/* state var info */
...
extern void sf_internal_set_sim_state_c9_experiment1_model_new(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c9_experiment1_model_new
    ((SFc9_experiment1_model_newInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c9_experiment1_model_new(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c9_experiment1_model_new(S);
}

static void sf_opaque_set_sim_state_c9_experiment1_model_new(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c9_experiment1_model_new(S, st);
}

static void sf_opaque_terminate_c9_experiment1_model_new(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_experiment1_model_newInstanceStruct*) chartInstanceVar)
      ->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c9_experiment1_model_new((SFc9_experiment1_model_newInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc9_experiment1_model_new
    ((SFc9_experiment1_model_newInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_experiment1_model_new(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c9_experiment1_model_new
      ((SFc9_experiment1_model_newInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c9_experiment1_model_new(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c9_experiment1_model_new(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_experiment1_model_new(SimStruct *S)
{
  SFc9_experiment1_model_newInstanceStruct *chartInstance;
  chartInstance = (SFc9_experiment1_model_newInstanceStruct *)malloc(sizeof
    (SFc9_experiment1_model_newInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_experiment1_model_newInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c9_experiment1_model_new;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c9_experiment1_model_new;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c9_experiment1_model_new;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c9_experiment1_model_new;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c9_experiment1_model_new;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c9_experiment1_model_new;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c9_experiment1_model_new;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c9_experiment1_model_new;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_experiment1_model_new;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_experiment1_model_new;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c9_experiment1_model_new;
...
void c9_experiment1_model_new_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_experiment1_model_new(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_experiment1_model_new(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_experiment1_model_new(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_experiment1_model_new_method_dispatcher.\n"
