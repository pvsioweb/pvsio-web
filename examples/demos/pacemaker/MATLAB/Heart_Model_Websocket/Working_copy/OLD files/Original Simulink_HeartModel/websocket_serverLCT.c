 ...
 *
 *        uint32 y1 = WebsocketServer(double u1, double u2, double u3, uint32 y2[1], uint32 y3[1])
 *
 *   Simulink version           : 7.9 (R2012a) 29-Dec-2011
 *   C source code generated on : 22-Jun-2014 21:42:43
...
/*
   ...
   def.OutputFcnSpec = 'uint32 y1 = WebsocketServer(double u1, double u2, double u3, uint32 y2[1], uint32 y3[1])';
   def.TerminateFcnSpec = 'close_websocket()';
   def.HeaderFiles = {'websocket_server.h'};
   def.SourceFiles = {'websocket_server.c'};
   def.HostLibFiles = {'libwebsockets.so.4.0.0'};
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   */
  *y1 = WebsocketServer( *u1, *u2, *u3, y2, y3);
}
