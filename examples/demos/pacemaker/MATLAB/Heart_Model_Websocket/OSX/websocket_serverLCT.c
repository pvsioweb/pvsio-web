 ...
 *
 *        uint32 y1 = WebsocketServer(double u1, double u2, uint32 y2[1], uint32 y3[1])
 *
 *   Simulink version           : 8.5 (R2015a) 09-Feb-2015
 *   C source code generated on : 25-Mar-2015 10:22:51
...
/*
   ...
   def.OutputFcnSpec = 'uint32 y1 = WebsocketServer(double u1, double u2, uint32 y2[1], uint32 y3[1])';
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   */
  *y1 = WebsocketServer( *u1, *u2, y2, y3);
}
