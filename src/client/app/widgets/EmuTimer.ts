...
export class EmuTimer {
    ...
    constructor (id: string, opt: WidgetOptions) {
        this.id = id;
        this.type = "timer";
        ...
        this.buttonActionsQueue = ButtonActionsQueue.getInstance()
    ...
    */
    ...
    tick () {        
        ...
        this.buttonActionsQueue.queueGUIAction(this.timerFunction, this.callback);
        Recorder.addAction({
            id: this.id,
            timerEvent: this.timerEvent,
            timerFunction: this.timerFunction,
