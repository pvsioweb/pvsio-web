 ...
 * @date Apr 1, 2015
 *
 * @example <caption>Typical use of SoftButton APIs within a PVSio-web plugin module.</caption>
 * // Example module that uses SoftButton.
 * define(function (require, exports, module) {
 *     "use strict";
 *     var device = {};
 *     device.disp = new SoftButton("disp", { top: 222, left: 96, height: 8, width: 38 });
...
define(function (require, exports, module) {
    ...
    /**
     * @function <a name="SoftButton">SoftButton</a>
     ...
     * @memberof module:SoftButton
     * @instance
     */
    function SoftButton(id, coords, opt) {
        opt = opt || {};
        coords = coords || {};
        this.id = id;
        ...
        // if (opt.touchscreen) {
        var touchID = this.id;
        this.touchscreenBackgroundColor = opt.backgroundColor || "green";
        this.touchscreenFontColor = opt.fontColor || "white";
        ...
        opt.enabledWhen = (opt.enabledWhen && opt.enabledWhen !== "") ? opt.enabledWhen : "true";
        ...
        Widget.call(this, id, "softbutton");
        return this;
    }
    SoftButton.prototype = Object.create(Widget.prototype);
    SoftButton.prototype.constructor = SoftButton;
    SoftButton.prototype.parentClass = Widget.prototype;
    /**
     * Returns a JSON object representation of this Widget.
     * @returns {object}
     * @memberof module:SoftButton
    */
    SoftButton.prototype.toJSON = function () {
        return {
            id: this.id(),
            type: this.type(),
            evts: this.evts(),
    ...
    * Updates the location and size of the widget according to the given position and size
     */
    SoftButton.prototype.updateLocationAndSize = function (pos) {
        SoftButton.prototype.parentClass.updateLocationAndSize.apply(this, arguments);
        this.top = pos.y || 0;
        this.left = pos.x || 0;
     ...
     */
    SoftButton.prototype.remove = function () {
        SoftButton.prototype.parentClass.remove.apply(this);
     ...
     * @memberof module:SoftButton
     */
    SoftButton.prototype.boundFunctions = function () {
        if (this.touchscreen) {
    ...
    SoftButton.prototype.invertColors = function () {
        var tmp = this.backgroundColor;
        this.backgroundColor = this.fontColor;
        this.fontColor = tmp;
    ...
    SoftButton.prototype.invertGlyphiconColors = function () {
        var tmp = this.backgroundColor;
        this.backgroundColor = this.fontColor;
        this.fontColor = tmp;
        var elemIsBlinking = (document.getElementById(this.id()).getAttribute("class").indexOf("blink") >= 0);
    ...
    SoftButton.prototype.render = function (txt, opt) {
        opt = opt || {};
        ...
        // we need to parse the expression enabledWhen() to understand if the widget is visible or not
    ...
    SoftButton.prototype.renderGlyphicon = function (icon, opt) {
        opt = opt || {};
        this.txt = icon;
    ...
    SoftButton.prototype.renderMultiline = function (txt, opt) {
    ...
    SoftButton.prototype.hide = function () {
        this.div.style("display", "none");
        return this;
    };

    SoftButton.prototype.reveal = function () {
        this.div.style("display", "block");
        return this;
    };

    SoftButton.prototype.move = function (data) {
        data = data || {};
        if (data.top) {
            this.top = data.top;
