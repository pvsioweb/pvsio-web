...
define(function (require, exports, module) {
    ...
    var d3 = require("d3/d3"),
        formTemplate = require("text!./templates/displaySelectTransition.handlebars"),
        FormUtils = require("./FormUtils");
    
    var SelectTransitionView = Backbone.View.extend({
        ...
        render: function (data) {
            ...
            $("body").append(this.el);
            d3.select(this.el).select("#selectedTransition").node().focus();
            return this;
        },
        events: {
		...
		right: function (event) {
			...
			if (FormUtils.validateForm(form)) {
                var selectors = [ "selectedTransition" ];
    ...
    module.exports = {
        ...
        create: function (data) {
            return new SelectTransitionView(data);
        }
    };
});
