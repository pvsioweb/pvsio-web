...
define(function (require, exports, module) {
    ...
    var d3 = require("src/client/plugins/PrototypeBuilder/forms/node_modules/d3/d3"),
        formTemplate = require("text!./templates/displaySelectDatatype.handlebars"),
        BaseDialog = require("src/client/plugins/PrototypeBuilder/forms/node_modules/pvsioweb/forms/BaseDialog"),
        FormUtils = require("./FormUtils");

    var SelectDatatypeView = BaseDialog.extend({
        ...
        render: function (data) {
            ...
            $("body").append(this.el);
            d3.select(this.el).select("#selectedDatatype").node().focus();
            return this;
        },
        events: {
        ...
        right: function (event) {
            ...
            if (FormUtils.validateForm(form)) {
                var selectors = [ "selectedDatatype" ];
    ...
    module.exports = {
        ...
        create: function (data) {
            return new SelectDatatypeView(data);
        }
    };
});
