...
//            var svg = d3.select("#ContainerStateMachine").select("svg").node().cloneNode(true);
//            svg = d3.select(svg).attr("version", 1.1)
...
//                .html(emuchartsManager.getVariables()
//                      .map(function (v) {
//                        return v.name + ", " + v.type + ", " + v.value + "<br/>";
//                        }));
////                .html(d3.select("#StateAttributes").select("table").node().innerHTML);
//            
