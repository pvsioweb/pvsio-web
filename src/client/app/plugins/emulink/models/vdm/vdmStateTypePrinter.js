...
define(function (require, exports, module) {
    ...
    var vdmRecord, vdmStateTypeDefinition, vdmAssignmentExpression, vdmFieldDeclaration;
    
    function VDMStateTypePrinter() {
        /**
         ...
         */
        Handlebars.registerHelper("vdmStateTypeDefinition", function (context, options) {
            if (!context) { return ""; }
            return options.fn(context);
        });
        vdmStateTypeDefinition =
            Handlebars.compile(require("text!./templates/vdmStateTypeDefinition.handlebars"));
        /**
    ...
    VDMStateTypePrinter.prototype.printRecordValue = function (data) {
        return print_aux(data, vdmAssignmentExpression, vdmRecord, {isValue: true});
    };
    VDMStateTypePrinter.prototype.printRecordType = function (data) {
        return print_aux(data, vdmFieldDeclaration, vdmRecord, {isType: true});
    };
    VDMStateTypePrinter.prototype.printRecordAccessor = function (name) {
     ...
     */
    VDMStateTypePrinter.prototype.printTypeDefinition = function (data) {
        return vdmStateTypeDefinition({
            data: {
                name: data.name,
    ...
    module.exports = {
        create: function () {
            return new VDMStateTypePrinter();
        }
    };
});
