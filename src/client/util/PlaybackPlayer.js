...
define(function (require, exports, module) {
    "use strict";
    var ws = require("../WSManager").WSManager.getWebSocket(),
        WidgetManager = require("pvsioweb/WidgetManager").getWidgetManager(),
        ScriptItemView = require("./ScriptItemView"),
		StateParser = require("./PVSioStateParser"),
        d3 = require("src/client/plugins/PrototypeBuilder/forms/node_modules/d3/d3"), playing = false;
